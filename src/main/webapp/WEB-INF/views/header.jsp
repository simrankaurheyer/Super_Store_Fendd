...
<body style="background-image:url(resources/mainbg.jpg);background-attachment:fixed;" data-spy="scroll" data-offset="0" >
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <a href="${pageContext.request.contextPath }/" class="navbar-brand">SuperStore</a>
  </div>
