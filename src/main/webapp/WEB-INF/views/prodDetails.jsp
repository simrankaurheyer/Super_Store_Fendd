...
<div class="thumbnail col-sm-3">
		...
		<ul class="menu-items">
		<li>deep fried from a flour dough, and typically either ring-shaped or a number of shapes without a hole, 
		and often filled, but can also be ball-shaped ("doughnut holes"). Other types of batters can also be used, 
		and various toppings and flavorings are used for different types, such as sugar, chocolate, or maple glazing. 
		</li>
		<li>Doughnuts may also 
		include water, leavening, eggs, milk, sugar, oil, shortening, and natural</li>
